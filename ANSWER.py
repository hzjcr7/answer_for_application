...
class ReminderApp(customtkinter.CTk):
    def __init__(self):
        ...
        self.timer_label = customtkinter.CTkLabel(self.main_frame, text="Time Remaining: 00:05", font=("Segoe UI", 24, "bold"), text_color="#0000FF")
    ...
    def restart(self):
        ...
        self.countdown(5)  # Restart the countdown
